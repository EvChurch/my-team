...
import { GuideDetailContent } from "../../../../guides/[guideId]/guide-detail-content";

type Props = {
  params: Promise<{ guideId: string }>;
};

export default async function TeamGuideDetailPage({ params }: Props) {
  ...
  return (
    <HydrationBoundary state={dehydrate(queryClient)}>
      <Suspense fallback={<GuideDetailSkeleton />}>
        <GuideDetailContent guideId={guideId} backToTeam />
      </Suspense>
    </HydrationBoundary>
  );
}
